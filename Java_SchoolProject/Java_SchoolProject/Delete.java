...
public class Delete {
	...
	public void writeBackInFileForClasses() {
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\g8user\\Documents\\Projects\\class.txt"));
			for(Class ob : classesList) {
	...
	public void writeBackInFileForSubjects() {
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\g8user\\Documents\\Projects\\subject.txt"));
			for(Subject ob : subjectsList) {
	...
	public void teacherNamesFromFile() {
		...
		try {
			reader = new BufferedReader(new FileReader(
					"C:\\Users\\g8user\\Documents\\Projects\\teacher.txt"));
	...
	public void classesNamesFromFile() {
		...
		try {
			reader = new BufferedReader(new FileReader(
					"C:\\Users\\g8user\\Documents\\Projects\\class.txt"));
			String line = reader.readLine();
			while (line != null) {
				Class classes = new Class(line);
	...
	public void subjectsNamesFromFile() {
		...
		try {
			reader = new BufferedReader(new FileReader(
					"C:\\Users\\g8user\\Documents\\Projects\\subject.txt"));
			String line = reader.readLine();
			while (line != null) {
				Subject sub = new Subject(line);
